...
BOT2_CONFIG = {
    'name': 'Bot 2 - 16 Mã Pullback',
    'symbols': {
        'VGI': {'sl': 10.0, 'tp': 20.0, 'holding': 20, 'pullback': 0.10, 'ma100': True},
        'STB': {'sl': 10.0, 'tp': 20.0, 'holding': 20, 'pullback': 0.10, 'ma100': True},
        'FRT': {'sl': 8.0, 'tp': 16.0, 'holding': 20, 'pullback': 0.08, 'ma100': True},
        'ELC': {'sl': 8.0, 'tp': 16.0, 'holding': 20, 'pullback': 0.08, 'ma100': False},
        'HDB': {'sl': 6.0, 'tp': 12.0, 'holding': 20, 'pullback': 0.06, 'ma100': True},
        'TCB': {'sl': 6.0, 'tp': 12.0, 'holding': 20, 'pullback': 0.06, 'ma100': False},
        'PVT': {'sl': 8.0, 'tp': 16.0, 'holding': 20, 'pullback': 0.08, 'ma100': False},
        'GEX': {'sl': 8.0, 'tp': 16.0, 'holding': 20, 'pullback': 0.08, 'ma100': False},
        'BID': {'sl': 6.0, 'tp': 12.0, 'holding': 20, 'pullback': 0.06, 'ma100': False},
        'MWG': {'sl': 6.0, 'tp': 12.0, 'holding': 20, 'pullback': 0.06, 'ma100': False},
        'PET': {'sl': 10.0, 'tp': 20.0, 'holding': 20, 'pullback': 0.10, 'ma100': True},
        'VIX': {'sl': 8.0, 'tp': 16.0, 'holding': 20, 'pullback': 0.08, 'ma100': True},
        'HCM': {'sl': 5.0, 'tp': 10.0, 'holding': 20, 'pullback': 0.05, 'ma100': True},
        'MBB': {'sl': 6.0, 'tp': 12.0, 'holding': 20, 'pullback': 0.06, 'ma100': False},
        'BAB': {'sl': 6.0, 'tp': 12.0, 'holding': 20, 'pullback': 0.06, 'ma100': False},
        'BMI': {'sl': 6.0, 'tp': 12.0, 'holding': 20, 'pullback': 0.06, 'ma100': False},
    }
}
...
def scan_signals():
    tz_vn = pytz.timezone('Asia/Ho_Chi_Minh')
    print(f"\n🔍 [{datetime.now(tz_vn).strftime('%H:%M:%S %d/%m/%Y')}] Quét {BOT2_CONFIG['name']}...")
